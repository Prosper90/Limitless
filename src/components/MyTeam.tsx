      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  You'll be automatically registered when you purchase your
                  first NFT. Once registered, you can start building your team
        ...
        <div className="nerko-card mb-8">
          ...
          <p className="text-gray-500 text-xs mt-3">
            Share this link with friends. When they purchase NFTs using your
            link, you earn commissions up to 6 levels deep!
          </p>
        </div>
            ...
            {levelNames.map((name, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${levelColors[index]} flex items-center justify-center text-lg font-bold`}
                  >
                    L{index + 1}
                  </div>
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      Commission: {commissionAmounts[index]}
                    </p>
                  </div>
                </div>
